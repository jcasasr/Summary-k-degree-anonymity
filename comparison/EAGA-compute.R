...
########
if(dataset == "polbooks") {
    datasetDir <- paste(baseDir, "polbooks-EAGA/", sep="");
    ...
    datasetDir <- paste(baseDir, "polblogs-EAGA/", sep="");
...
computeMetricValues(datasetDir, datasetName, extension, kSet, s, e, mSet, "EAGA");
